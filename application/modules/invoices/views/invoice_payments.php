                        ...
                        <div class="col-sm-8 m-b-xs">
                            ...
                            <?php if(User::is_admin() || User::perm_allowed(User::get_id(),'edit_all_invoices')) { ?>
                                ...
                                <?php if ($inv->show_client == 'Yes') { ?>
                                    ...
                                    <a class="btn btn-sm btn-<?=config_item('theme_color')?>" href="<?= base_url() ?>invoices/hide/<?= $inv->inv_id ?>" data-toggle="tooltip" data-title="<?= lang('hide_to_client') ?>" data-placement="bottom"><i class="fa fa-eye-slash"></i>
                                    </a>
                                ...
                                <?php } else { ?>
                                    ...
                                    <a class="btn btn-sm btn-<?=config_item('theme_color')?>" href="<?= base_url() ?>invoices/show/<?= $inv->inv_id ?>" data-toggle="tooltip" data-title="<?= lang('show_to_client') ?>" data-placement="bottom"><i class="fa fa-eye"></i>
                                    </a>
