...
<div class="col-md-12">
    <div class="row">
            ...
            <section class="panel panel-default">
                ...
                <div class="panel-footer">
                    <small><?= lang('total_outstanding') ?> : <strong>
                            <?= Applib::format_currency(config_item('default_currency'), $outstanding) ?></strong>
                    </small>
                </div>
            </section>
        </div>
        <div class="col-lg-4">
            <section class="panel panel-default">
                ...
                <div class="panel-body text-center">
                    <div class="inline">
                        <div class="easypiechart" data-percent="<?= $perc_paid ?>" data-line-width="6" data-loop="false"
                             data-size="188">
                ...
                <div class="panel-footer">
                    <small><?= lang('total_receipts') ?> : <strong>
                            <?= Applib::format_currency(config_item('default_currency'), $total_receipts) ?></strong>
                    </small>
                </div>
            </section>
        </div>
        <div class="col-lg-4">
            <section class="panel panel-default">
                ...
                <div class="panel-body text-center">
                    <div class="inline">
                        <div class="easypiechart" data-percent="<?= $perc_outstanding ?>" data-line-width="30"
                             data-track-color="#eee" data-bar-color="#afcf6f" data-scale-color="#fff" data-size="188"
                             data-line-cap='butt'>
                ...
                <div class="panel-footer">
                    <small><?= lang('total_sales') ?>: <strong>
                            <?= Applib::format_currency(config_item('default_currency'), $total_sales) ?></strong>
                    </small>
                </div>
            </section>
        </div>
    ...
    <div class="row">
        <section class="panel panel-default">
            ...
            <header class="panel-heading font-bold"><i class="fa fa-info-circle"></i> <?= lang('revenue_collection') ?>
                - <?= config_item('default_currency') ?></header>
