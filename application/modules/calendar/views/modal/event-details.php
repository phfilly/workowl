<div class="modal-dialog">
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <a href="<?=base_url('projects/view/' . $task->project . '?group=tasks&view=task&id=' . $task->t_id)?>" class="btn btn-<?=config_item('theme_color')?> text-white"><?=lang('view_task')?></a>
        </div>
            <?php endif; ?>
        ...
        <div class="modal-footer">
            <a href="#" class="btn btn-default" data-dismiss="modal"><?=lang('close')?></a>
            <a href="<?= base_url('payments/view/'.$payment->p_id) ?>" class="btn btn-<?=config_item('theme_color')?> text-white"><?=lang('view_payment')?></a>
        </div>
            <?php endif; ?>
        ...
        <div class="modal-footer">
            <a href="#" class="btn btn-default" data-dismiss="modal"><?=lang('close')?></a>
            <a href="<?= base_url('projects/view/' . $project->project_id) ?>" class="btn btn-<?=config_item('theme_color')?> text-white"><?=lang('view_project')?></a>
        </div>
            <?php endif; ?>
        ...
        <div class="modal-footer">
            <a href="#" class="btn btn-default" data-dismiss="modal"><?=lang('close')?></a>
            <a href="<?= base_url('invoices/view/' . $invoice->inv_id) ?>" class="btn btn-<?=config_item('theme_color')?> text-white"><?=lang('view_invoice')?></a>
        </div>
            <?php endif; ?>
        ...
        <div class="modal-footer">
            <a href="#" class="btn btn-default" data-dismiss="modal"><?=lang('close')?></a>
            <a href="<?= base_url('estimates/view/' . $estimate->est_id) ?>" class="btn btn-<?=config_item('theme_color')?> text-white"><?=lang('view_estimate')?></a>
        </div>
            <?php endif; ?>
      ...
      <img src="<?=User::avatar_url($event->added_by); ?>" class="img-rounded" style="border-radius: 6px;">
        ...
        <div class="modal-footer">
            ...
            <a href="<?= base_url('calendar/edit_event/'.$event->id) ?>" class="btn btn-<?=config_item('theme_color')?> text-white" data-toggle="ajaxModal" data-dismiss="modal"><?=lang('edit_event')?>
