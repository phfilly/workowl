                    ...
                    <div class="row padder">
                        ...
                        <section class="panel panel-default">
                            <header class="panel-heading">
                                <a href="<?=base_url()?>updates/check/" class="btn btn-<?=config_item('theme_color')?> btn-xs pull-right"><?=lang('check_for_updates')?></a>
                                <?=lang('updates')?></header>
                            <div class="table-responsive">
                                <table id="table-clients" class="table table-striped m-b-none">
                                    ...
                                    <?php foreach ($installed as $iup) : ?>
                                        <tr>
                                            <td><?=$iup->build?></td>
                                            <td><?=$iup->title?> <span class="badge"><?=$iup->code?></span></td>
                        ...
                        <section class="panel panel-default">
                            <header class="panel-heading">
                                <a href="<?=base_url()?>updates/backup/" class="btn btn-<?=config_item('theme_color')?> btn-xs pull-right"><?=lang('backup_now')?></a>
                                <?=lang('backups')?></header>
                            <div class="table-responsive">
                                <table id="table-clients" class="table table-striped m-b-none">
                                    <tbody>
                                    <?php foreach ($backups as $file) : ?>
                                        <tr>
                                            <td>
                                                ...
                                                <a href="<?=base_url()?>updates/delete_file/<?=$file?>" class="btn btn-danger btn-xs pull-right" onclick="return confirm('Are you sure you want to delete this file?');"><?=lang('delete')?></a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
