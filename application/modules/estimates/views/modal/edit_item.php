<div class="modal-dialog">
	<div class="modal-content">
		...
		<?php $item = Estimate::view_item($id); ?>
		...
		<div class="modal-body">
				...
				<div class="col-lg-8">
					<input type="text" class="form-control money" value="<?=$item->quantity?>" name="quantity">
				</div>
				</div>
				...
				<div class="col-lg-8">
					<input type="text" class="form-control money" value="<?=$item->unit_cost?>" name="unit_cost">
				</div>
				</div>
				...
				<div class="col-lg-8">
					<select name="item_tax_rate" class="form-control m-b">
						...
						<?php foreach (Estimate::rates() as $key => $tax) { ?>
