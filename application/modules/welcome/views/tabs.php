                    ...
                    <section class="scrollable">
                      <div class="tab-content">
                        <div class="tab-pane active" id="projects">
                          ...
                          <table class="table table-striped m-b-none text-sm clickable">
                            <thead>
                                <tr>
...
if (count($projects) > 0) {
    ...
    <?php }
                                    ...
                                    <tr>
                                        <td class="it" colspan="4"><?=lang('nothing_to_display')?></td>
                                    </tr>
<?php } ?>
                            </tbody>
                        </table>
...
if (!empty($bugs)) {
    foreach ($bugs as $key => $bug) {
      ...
      <img src="<?=User::avatar_url($bug->assigned_to); ?>" class="img-rounded" style="border-radius: 6px;">
