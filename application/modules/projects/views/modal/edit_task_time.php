		...
		if(count($timers) > 0){
			...
			<div class="form-group">
				...
				<a class="thumb-xs pull-left m-r-sm">
                            ...
                            <img src="<?php echo User::avatar_url($t->user); ?>" class="img-circle" data-toggle="tooltip" data-title="<?=User::displayName($t->user)?>" data-placement="left" class="img-rounded" style="border-radius: 6px;"> </a>
