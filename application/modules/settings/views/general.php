                    ...
                    <div class="tab-content tab-content-fix">
                        <div class="tab-pane fade in active" id="tab-english">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-5">
                                    <textarea class="form-control" name="company_address" required><?=config_item('company_address')?></textarea>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <?php foreach($translations as $lang) : ?>
                            <div class="tab-pane fade" id="tab-<?=$lang?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-5">
                                        <textarea class="form-control" name="company_address_<?=$lang?>"><?=config_item('company_address_'.$lang)?></textarea>
                                    </div>
                                </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label"><?=lang('zip_code')?> </label>
