        ...
        <section class="scrollable wrapper">
          <section class="panel panel-default">
            ...
            <?php if($this->uri->segment(3)){ ?>
              <a href="<?=base_url()?>reports/expensespdf/<?=strtotime($start_date)?>/<?=strtotime($end_date)?>/<?=$report_by?>" class="btn btn-dark btn-sm pull-right"><i class="fa fa-file-pdf-o"></i><?=lang('pdf')?>
              </a>
            <?php } ?>
